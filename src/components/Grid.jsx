        ...
        <div className="main-div">
            ...
            <div className="cod">
                <Iframe
                    ...
                    width=" 100%" height="582px" border="0" transform="scale(1)" overflow="hidden" frameBorder="0"
            ...
            <div className="cod">
                <Iframe
                    ...
                    width=" 100%" height="720px" border="0" transform="scale(1)" overflow="hidden" frameBorder="0"
                    sandbox="allow-scripts allow-same-origin">
                </Iframe>
